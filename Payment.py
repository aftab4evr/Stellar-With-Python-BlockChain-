...
if __name__ == '__main__':
    at=Asset(code='MOB', issuer='GALT7IJPOR37NJFXFBD4ZYME5C23KXTVQTB4XHY3CQ2LPJJRP3VXR4AS')
    transfer_fund(10,at,
    'GBVS3DRQRIMCZW5AGYPJOHFMHIQADTEIJICRZ475OWG25FPLPGHW77IC',
    'GALT7IJPOR37NJFXFBD4ZYME5C23KXTVQTB4XHY3CQ2LPJJRP3VXR4AS',
    'SAPGVLD52VW6LMFNAI2YJJZRPWNBQRLKTLKAEFDFHOTP36Y45IVJ2GSB'
    )
